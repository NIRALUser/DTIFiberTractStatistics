...
inline charp ipGetStringArgument(char **argv, const char *keystr, const charp defval)
{
...
// end of args
inline int ipGetStringMultipArgument(char **argv, const char *keystr, char **out, const int max) {
  int i = 1, num;
  while (argv[i]) {
    if (strstr(argv[i],keystr)) {
      // keystr found
...
inline int ipGetIntArgument(char **argv, const char *keystr, const int defval) {
...
inline float ipGetFloatArgument(char **argv, const char *keystr, const float defval) {
...
inline double ipGetDoubleArgument(char **argv, const char *keystr, const double defval) {
